...
func wireApp(configConfig *config.Config, logger *lumberjack.Logger, zapLogger *zap.Logger) (*App, func(), error) {
	...
	userHandler := handler.CreateUserHandler(service)
	...
	engine := router.SetupRouter(configConfig, middlewareLogger, recovery, cors, userHandler, promptHandler, promptVersionHandler, categoryHandler, favoriteHandler, recentlyUsedHandler)
